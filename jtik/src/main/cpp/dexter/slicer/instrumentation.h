...
class EntryHook : public Transformation {
 public:
  ...
  explicit EntryHook(const ir::MethodId& hook_method_id, long j_method_id, Tweak tweak)
      : hook_method_id_(hook_method_id), j_method_id_(j_method_id), tweak_(tweak) {
  ...
  // `tweak` constructor.
  explicit EntryHook(const ir::MethodId& hook_method_id, long j_method_id,
 ...
 public:
  enum class Tweak {
   ...
   explicit ExitHook(const ir::MethodId& hook_method_id, long jmethod_id, Tweak tweak)
      : hook_method_id_(hook_method_id), j_method_id_(jmethod_id), tweak_(tweak) {
    // hook method signature is generated automatically
    SLICER_CHECK(hook_method_id_.signature == nullptr);
  }

  explicit ExitHook(const ir::MethodId& hook_method_id, long jmethod_id) : ExitHook(hook_method_id, jmethod_id, Tweak::None) {}
